        ...
        routes.forEach(function (route) {
            ...
            if (route.security) {
                ...
                securitySchemes.forEach(function (securityDefinitionName) {
                    ...
                    var routeSecurity = route.security[securityDefinitionName];
                    if (routeSecurity && routeSecurity.authorizations) {
                        config.auth.scope = route.security[securityDefinitionName].authorizations;
                    }
                });
            }
